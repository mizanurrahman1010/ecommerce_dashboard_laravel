function dropupclose(){
	$(".dropup-content").hide('slide');
}
...
$(document).ready(function(){
	...
	$("#filter").on('click', function(e){
		   $("#filter_form").toggle('slide');
		});
	$(".form_close").on('click', function(e){
		   $("#filter_form").toggle('slide');
		});

	$(".bottom-profile-button").on('click', function(e){
		   $(".dropup-content").toggle('slide');
		});

	$("#mbl-srch").on('click', function(e){
			var status = $(this).attr("status");
			if (status == 0) {
				$(this).attr('status','1');
				$(this).html('<i class="fa fa-close" aria-hidden="true"></i> Close');
				$(this).removeClass( "btn-primary" ).addClass( "btn-danger" );
				$(".srch-area").show('slide');
